...
class Verses1_Deatils extends StatelessWidget {
  const Verses1_Deatils({super.key});
                            ...
                            child: Center(
                              child: SingleChildScrollView(
                                child: Column(
                                  ...
                                  children: [
                                    Center(child: Text("${Provider.of<Hindi_Controller>(context).H1[index].description}",style: GoogleFonts.poppins(fontSize: 15,fontWeight: FontWeight.bold),)),
                                    Center(child: Text("${Provider.of<English_Controller>(context).E1[index].description}",style: GoogleFonts.poppins(fontSize: 15,fontWeight: FontWeight.bold),)),
                                  ],
                                ),
                              ),
                            ),
