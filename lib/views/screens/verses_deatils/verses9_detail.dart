...
class Verses9_Deatils extends StatelessWidget {
  const Verses9_Deatils({super.key});
              ...
              builder: (context,provider,_) {
                return Scaffold(
                  ...
                  body:TCard(controller: cardController,
                      size: Size(700, 700),
                      cards: List.generate(provider.All_Verses9.length, (index) {
                        return Stack(
                          children: [
                            Padding(
                              ...
                              child: Center(
                                child: SingleChildScrollView(
                                  child: Column(
                                    ...
                                    children: [
                                      Center(child: Text("${Provider.of<Hindi_Controller>(context).H9[index].description}",style: GoogleFonts.poppins(fontSize: 15,fontWeight: FontWeight.bold),)),
                                      Center(child: Text("${Provider.of<English_Controller>(context).E9[index].description}",style: GoogleFonts.poppins(fontSize: 15,fontWeight: FontWeight.bold),)),
                                    ],
                                  ),
                                ),
                              ),
