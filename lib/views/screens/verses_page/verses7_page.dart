...
class Verses7_Page extends StatelessWidget {
  const Verses7_Page({super.key});
                    ...
                    children: [
                            ...
                            child: ClipRRect(
                                ...
                                child: Opacity(
                                    ...
                                    child: GestureDetector(
                                        onTap: (){
                                          Navigator.of(context).pushNamed(Myroutes.verse7,arguments: index);
                                        },
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Center(child: Text("${provider.All_Verses7[index].text}",style: GoogleFonts.poppins(fontSize: 20,fontWeight: FontWeight.bold),)),
                            SizedBox(height: 20,),
