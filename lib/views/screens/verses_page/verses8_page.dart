...
class Verses8_Page extends StatelessWidget {
  const Verses8_Page({super.key});
                    ...
                    children: [
                            ...
                            child: ClipRRect(
                                ...
                                child: Opacity(
                                    ...
                                    child: GestureDetector(
                                        onTap: (){
                                          Navigator.of(context).pushNamed(Myroutes.verse8,arguments: index);
                                        },
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Center(child: Text("${provider.All_Verses8[index].text}",style: GoogleFonts.poppins(fontSize: 20,fontWeight: FontWeight.bold),)),
                            SizedBox(height: 20,),
